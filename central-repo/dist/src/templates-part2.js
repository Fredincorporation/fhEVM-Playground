...
// ============================================================================
export function singleEncryptionContract() {
...
export function singleEncryptionTest() {
...
// ============================================================================
export function multipleEncryptionContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function multipleEncryptionTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
// ============================================================================
export function singleDecryptionUserContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function singleDecryptionUserTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
// ============================================================================
export function singleDecryptionPublicContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function singleDecryptionPublicTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
// ============================================================================
export function multipleDecryptionContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function multipleDecryptionTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
//# sourceMappingURL=templates-part2.js.map
 ...
 */
export function accessControlContract() {
...
export function inputVerificationProofsContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function inputVerificationProofsTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function antiPatternsGuideContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function antiPatternsGuideTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function handlesLifecycleContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function handlesLifecycleTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
//# sourceMappingURL=templates-part3.js.map
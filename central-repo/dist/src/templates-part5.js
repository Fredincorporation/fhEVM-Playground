 ...
 */
export function daoVotingProContract() {
...
export function daoVotingProTest() {
...
export function privateLendingProContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function privateLendingProTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function blindDexProContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function blindDexProTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function pokerGameProContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function pokerGameProTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function yieldFarmingProContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function yieldFarmingProTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function mevArbitrageProContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function mevArbitrageProTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
export function confidentialStablecoinProContract() {
    return `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function confidentialStablecoinProTest() {
    return `import { expect } from "chai";
import { ethers } from "hardhat";
...
//# sourceMappingURL=templates-part5.js.map
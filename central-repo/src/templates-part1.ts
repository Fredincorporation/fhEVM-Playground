...
export function basicCounterContract(): string {
...
export function basicCounterTest(): string {
...
export function arithmeticContract(): string {
  return \`// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function arithmeticTest(): string {
  return \`import { expect } from "chai";
import { ethers } from "hardhat";
...
export function comparisonsContract(): string {
  return \`// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function comparisonsTest(): string {
  return \`import { expect } from "chai";
import { ethers } from "hardhat";

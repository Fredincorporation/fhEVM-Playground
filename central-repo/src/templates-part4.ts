...
export function ozErc20WrapperContract(): string {
...
export function ozErc20WrapperTest(): string {
...
export function ozErc7984BasicContract(): string {
  return \`// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function ozErc7984BasicTest(): string {
  return \`import { expect } from "chai";
import { ethers } from "hardhat";
...
export function swapsContract(): string {
  return \`// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function swapsTest(): string {
  return \`import { expect } from "chai";
import { ethers } from "hardhat";
...
export function vestingContract(): string {
  return \`// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function vestingTest(): string {
  return \`import { expect } from "chai";
import { ethers } from "hardhat";
...
export function blindAuctionContract(): string {
  return \`// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
export function blindAuctionTest(): string {
  return \`import { expect } from "chai";
import { ethers } from "hardhat";

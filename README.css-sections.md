...
:root {
    /* Color Palette - Golden Yellow, Black & White */
    --color-gold: #FFD700;
    ...
    --gradient-card: linear-gradient(135deg, rgba(255, 215, 0, 0.1) 0%, rgba(218, 165, 32, 0.05) 100%);
...
body.dark-mode .navbar-logo .logo-accent {
...
@media (max-width: 900px) {
    .hero-content { grid-template-columns: 1fr; gap: var(--spacing-md); }
    .hero-graphic { order: -1; }
    .code-preview { max-width: 100%; }
    .hero { min-height: auto; margin-top: 60px; padding-top: 40px; padding-bottom: 40px; }
}
...
.code-preview {
    ...
    font-family: var(--font-mono);
    box-shadow: 0 20px 60px rgba(0, 209, 255, 0.1);
    backdrop-filter: blur(10px);
    position: relative;
    overflow: hidden;
}
...
body.dark-mode .quick-start-card {
    background: linear-gradient(135deg, rgba(255, 215, 0, 0.08) 0%, rgba(218, 165, 32, 0.03) 100%);
...
body.dark-mode .quick-start-card:hover {
...
.cli-box {
    background: linear-gradient(135deg, rgba(255, 215, 0, 0.08) 0%, rgba(218, 165, 32, 0.05) 100%);
    border: 2px solid rgba(255, 215, 0, 0.2);
    border-radius: 12px;
...
body.dark-mode .cli-box {
    background: linear-gradient(135deg, rgba(255, 215, 0, 0.1) 0%, rgba(218, 165, 32, 0.08) 100%);
    border-color: rgba(255, 215, 0, 0.3);
}
...
.search-box:focus {
    ...
    background-color: rgba(10, 29, 55, 0.8);
}
...
.feature-card {
    background: linear-gradient(135deg, rgba(75, 46, 131, 0.1) 0%, rgba(0, 209, 255, 0.05) 100%);
    border: 1px solid rgba(0, 209, 255, 0.1);
    border-radius: 12px;
    padding: var(--spacing-xl);
    text-align: center;
...
.copy-btn:hover, .copy-btn-large:hover {
...
.codespaces-badge-large { height:56px; border-radius:8px; box-shadow: 0 8px 30px rgba(0,209,255,0.06); }
...
.accordion-toggle:after { content:'▸'; float:right; transition: transform 200ms; }
